        ...
        <div class="m-portlet m-portlet--tab">
            ...
            <div class="m-portlet__head-caption">
                <div class="d-flex align-items-center logo-box justify-content-between box-header with-border">
                    <h4 class="box-title">تعديل النقاط</h4>
                    @can('student-create')
            ...
            <div class="box-body">
                <!--begin::Form-->
                <form method="POST" action="{{ route('dashboard.student.editWallet') }}" class="m-form m-form--fit m-form--label-align-right" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group m-form__group row">
                        <label class="col-lg-2 col-form-label">تعديل الرصيد</label>
                        <div class="col-lg-6">
