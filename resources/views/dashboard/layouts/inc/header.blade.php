        ...
        <ul class="nav navbar-nav">	
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu animated flipInX">
              <li class="user-body">
				 {{-- <a class="dropdown-item" href="{{ auth()->user()->hasRole('admin') ? route('dashboard.profile.index') : route('dashboard.teacher.profile.index') }}"><i class="ti-user text-muted me-2"></i> الحساب</a> --}}
				 {{-- <a class="dropdown-item" href="#"><i class="ti-wallet text-muted me-2"></i> My Wallet</a> --}}
				 {{-- <a class="dropdown-item" href="#"><i class="ti-settings text-muted me-2"></i> Settings</a> --}}
				 <div class="dropdown-divider"></div>
				 @if(Auth::user()->hasRole('admin'))
					<a class="dropdown-item" href="{{ route('dashboard.logout') }}"><i class="ti-lock text-muted me-2"></i> تسجيل خروج</a>
				 @else
					<a class="dropdown-item" href="{{ route('dashboard.teacher.logout') }}"><i class="ti-lock text-muted me-2"></i>تسجيل خروج</a>
				@endif
