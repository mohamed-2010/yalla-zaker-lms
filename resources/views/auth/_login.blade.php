        ...
        <div class="container">
            <div class="row">
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12">
                    <div class="card text-white mb-3 loginsections">
                        <div class="card-header header-login">
                            <h1 class="header-logined">تسسجيل الدخول</h1>
                        </div>
                        <div class="card-body">
                            <div class="mb-3 form-groups mx-auto">
                                <label for="exampleFormControlInput1" class="form-label form-labeld">رقم تليفون
                                    الطالب</label>
                                <input type="number" class="form-control form-controled" id="exampleFormControlInput1"
                                    placeholder="رقم تليفون الطالب ...">
                            </div>

                            <div class="mb-3 form-groups mx-auto">
                                <label for="exampleFormControlInput1" class="form-label form-labeld">كلمة المرور</label>
                                <input type="number" id="newPass" class="form-control form-controled commanClass" id="exampleFormControlInput1"
                                    placeholder="كلمة المرور ...">
                                    <i onclick="show('newPass')" class="fas fa-eye-slash" id="display" style="cursor: pointer"></i>
                            </div>
                ...
                <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-12 col-sm-12 col-xs-12 col-12">
                    <div class="imageedlogo mx-auto text-center">
                        <img src="{{asset('web')}}/image/logo.png" alt=""  class="logopageslong">
